...
internal static class ConsoleHost
{
    ...
    private static void RebindStandardStreams()
    {
        ...
        Console.SetOut(new StreamWriter(stdout, new UTF8Encoding(encoderShouldEmitUTF8Identifier: false)) { AutoFlush = true });
        Console.SetError(new StreamWriter(stderr, new UTF8Encoding(encoderShouldEmitUTF8Identifier: false)) { AutoFlush = true });
